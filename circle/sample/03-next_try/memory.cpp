...
bool            CKernel::memory_allocate            ()
{
                ...
                m_bufferFrameBufferB= memory_init_dma_buffer(   1, FRAME_SIZE,
                                                                ...
                                                                &m_frameRawBlockB,
                                                                &m_frameBlockSizeB);
                m_BufferOverlayTexture= memory_init_dma_buffer(   1, TEX_SIZE,                    // <- need to be adapted !!
                ...
                m_bufferFoverlay    = memory_init_buffer( 1,                FSH_SIZE );         // <- new        
                m_bufferFshader     = memory_init_buffer( FSH_SD + FSH_USB, FSH_SIZE );
