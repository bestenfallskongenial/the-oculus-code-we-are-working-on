...
/*
// i thought i might need to alloc my memory by via vpu so i introduced allocMemoryVCSM 
// and here are the debug level members but in the end everything worked out:)
// anyway - i keep them here for now, who knows!
