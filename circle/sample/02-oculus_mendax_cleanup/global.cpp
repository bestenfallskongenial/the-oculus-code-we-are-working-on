...
// same here, a separate file just for the colors, also for the waveforms
{ 0, 0, 0},// 0: off/black
...
// Waveform tables for LFOs - these are just example values, you can replace them with actual waveforms
// who the fuck said this are "just example values"? are you kidding me?!
// exclude in a separate file!
unsigned long           waveTable                               [WAVEFORMS][WAVESAMPLES]    = 
