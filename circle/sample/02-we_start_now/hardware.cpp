...
void            CKernel::my_write32                 (   uintptr nAddress, 
                                                        u32 nValue)
{
                *(volatile u32 *) nAddress = nValue;
}

void            CKernel::my_GPIO_SetPull            (   unsigned nPin, 
                                                        unsigned nPullMode)
{
...
void            CKernel::my_GPIO_SetAlt             (   unsigned nPin, 
                                                        unsigned nAltMode, 
                                                        unsigned nPullMode)
{
...
void            CKernel::my_GPIO_Write              (   unsigned nPin, 
                                                        unsigned nValue)
{
                uintptr nReg =
