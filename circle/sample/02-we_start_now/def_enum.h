...
enum lfo_bpm_types
{
    int BPM =0,         									// result BPM
    int INTV,           									// intervalCalculated
    int NBT,            									// nextBeatTime
    int LCB,            									// lastCircleBuffer
   	int NCB,            									// nextCircleBuffer
    int LBC,            									// lastBpmCalculation
    int LBCT,           									// lastBpmCalculationTMP
    int LMT,            									// lfoMultiplierTMP
    int ELP,            									// elapsedMicroseconds
    int CYL,            									// cycleLength
    int SMP,            									// sampleIndex
    int LTIME,          									// lastTime
    int TIDX,           									// timeIndex
