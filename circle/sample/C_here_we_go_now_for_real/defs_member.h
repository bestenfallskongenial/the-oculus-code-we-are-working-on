...
public:         // Logging
                ...
                char                            m_logKernel[LOG_SIZ]                            =       {0};          //  pre-init buffer 
...
#endif
                EGLDisplay                      m_eglDisplay;      // is stored in the olg_state struct -> display     and needed by bufferReadyMMAL        // placeholder until i solved this!
