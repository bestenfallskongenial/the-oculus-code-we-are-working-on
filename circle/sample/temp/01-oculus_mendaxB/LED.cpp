...
void            CKernel::LED_circle_color        ()                    // simple display_debug / feedback function
{
                ...
                m_NeoPixels.SetLED (SD_LINE1, 2, (g_waveTable[0][1*counter%255]>>4), (g_waveTable[0][2*counter%255]>>4), (g_waveTable[0][3*counter%255]>>4) );
                m_NeoPixels.SetLED (SD_LINE1, 1, (g_waveTable[0][2*counter%255]>>4), (g_waveTable[0][3*counter%255]>>4), (g_waveTable[0][1*counter%255]>>4) );
                m_NeoPixels.SetLED (SD_LINE1, 3, (g_waveTable[0][3*counter%255]>>4), (g_waveTable[0][1*counter%255]>>4), (g_waveTable[0][2*counter%255]>>4) );
                m_NeoPixels.SetLED (SD_LINE1, 0, (g_waveTable[0][2*counter%255]>>4), (g_waveTable[0][1*counter%255]>>4), (g_waveTable[0][3*counter%255]>>4) );
