...
bool            CKernel::filesystem_open_file       (   const char *p_fileName)		
...
void            CKernel::gfx_init_vshaders          (   CUBE_STATE_T *state, int p_fromFile, int p_toFile)
void            CKernel::gfx_init_fshaders          (   CUBE_STATE_T *state, int p_fromFile, int p_toFile)
void            CKernel::gfx_init_programs          (   CUBE_STATE_T *state, int p_fromFile, int p_toFile)
void            CKernel::gfx_init_uniforms          (   CUBE_STATE_T *state, int p_fromFile, int p_toFile)
...
void            CKernel::parser_teture_bmp          (   int p_fromFile, int p_toFile)
...
void            CKernel::util_random_vec8           (uint32_t p_seed)
